...
En este ejemplo se trata de hacer algo un poco más complejo jugando con los conocimientos de la MS.
...
Internamente la MS guarda esta dirección de retorno en la pila (stack) al llamar a la función
...
**(\*)** Esto en el codigo de la MS no es tan literal, ya que en vez de comprobar si el registro RE es 0xFF,
comprobamos si está activado el flag de carry.

El código en la MS es:
